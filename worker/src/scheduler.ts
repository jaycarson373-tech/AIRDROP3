...
console.log(`Trump Strategy worker started. Schedule: every ${config.epochMinutes} minutes.`);
console.log(
...
console.log(`Reward buyback allocation: ${config.ansemBuyBps} bps of usable creator fees is available for WLFI/TRUMP reward buys after reserves.`);
