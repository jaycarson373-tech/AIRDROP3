...
Robin Hood routes creator fees back to the trenches with live reward drops for eligible holders.

## Reward Engine

- Snapshot eligible `$HOOD` holders.
- Claim creator fees.
- Buy the configured reward token.
- Airdrop rewards automatically to eligible holders on the configured epoch.
...
NEXT_PUBLIC_BUY_URL=https://jup.ag/?sell=So11111111111111111111111111111111111111112&buy=<SOURCE_TOKEN_MINT>
