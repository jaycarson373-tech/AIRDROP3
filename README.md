...
8. Pick one selected recipient as the separate 5x Bank Bonus winner when balance allows.
...
- One selected recipient can receive the separate 5x Bank Bonus.
...
```bash
NEXT_PUBLIC_PROJECT_NAME="HoodBank"
