  ...
  return new ImageResponse(
    <div style={{ width: "100%", height: "100%", display: "flex", background: "#050505", color: "#f7f7f2", padding: "72px", fontFamily: "Arial, sans-serif", position: "relative", overflow: "hidden" }}>
      ...
      <div style={{ display: "flex", flexDirection: "column", justifyContent: "space-between", position: "relative" }}>
        ...
        <div style={{ display: "flex", flexDirection: "column" }}><div style={{ color: "#8cff72", fontSize: 22, textTransform: "uppercase", marginBottom: 20 }}>Live momentum terminal</div><div style={{ fontSize: 76, fontWeight: 800, maxWidth: 940, lineHeight: 1.02, letterSpacing: 0 }}>Own the runner. Don't chase it.</div></div>
        <div style={{ fontSize: 25, color: "#8e8e88" }}>Momentum signals. Holder drops. Public receipts.</div>
      </div>
    </div>,
    size
  );
